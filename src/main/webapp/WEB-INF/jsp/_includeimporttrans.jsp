				...
				<s:elseif test="trans.status=='OK'">
					...
					<div class="iroot">
						<s:if test="rootDefined">
							...
							<script>
							var tooltiproot < s:property value = "dbID" / > = new YAHOO.widget.Tooltip("tooltiproot<s:property value="dbID"/>", { context:"root_stat<s:property value="dbID"/>", text:"Item root defined", width:"400px"});					    </script>
						</s:if>
						<s:else>
							...
							<script>
							var tooltiproot < s:property value = "dbID" / > = new YAHOO.widget.Tooltip("tooltiproot<s:property value="dbID"/>", { context:"root_stat<s:property value="dbID"/>", text:"Item root undefined", width:"400px"});					    </script>
